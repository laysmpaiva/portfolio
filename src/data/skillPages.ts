...
export const skillPages: Record<string, any> = {
    ...
    walkthrough: [
      {
        ...
        imgCap: 'The one-line prompt that starts a run',
      },
      {
        icon: '❓',
      ...
      },
      {
        ...
        img: '/tooling/foreplay-run.png',
        imgCap: 'It pulls a live ad from the swipe file and writes the teardown it builds from',
        img2: '/tooling/foreplay-ad.png',
        imgCap2: 'The inspiration ad it pulled, straight from the swipe file',
      },
      {
        icon: '✍️',
        ...
        imgCap: '3 hooks + a universal body, each with a flow check',
      },
      {
        icon: '🚢',
        ...
        imgCap: 'The full handoff: concept page, designer brief, asset folder',
      },
      {
        icon: '🎛️',
        ...
        imgCap: 'Approved copy already in a sheet; the skill picks up from there',
  ...
  'canva-templates': {
    ...
    templatesCap: 'Every master designed once in Canva, fonts and layouts locked. The skills duplicate from here; the originals never get touched.',
    walkthrough: [
      {
        icon: '🖼️',
      ...
      },
      {
        ...
        imgCap: 'The one-line prompt that started the run',
      },
      {
        icon: '📝',
        ...
        imgCap: '5 qualifier variations, generated in under 3 minutes',
      },
      {
        icon: '🚢',
        ...
        imgCap: 'Four pages in Canva, one per approved variation',
      },
      {
        icon: '🔗',
        h: 'The full handoff',
  ...
  'weekly-report': {
    ...
    walkthrough: [
      ...
      },
      {
        ...
        imgCap: 'A real Friday draft in my review channel, client numbers blurred',
      },
      {
        icon: '🔁',
    ...
    walkthrough: [
      {
        ...
        imgCap: 'My /skills list: dozens of skills, all locked by the plugin',
      },
      {
        icon: '🔒',
        ...
        imgCap: 'One versioned repo: 73 commits, 3 contributors, one source of truth',
      ...
      },
      {
        ...
        img: '/tooling/start-here.png',
        imgCap: 'The onboarding page: one-time install, a tutorial card per skill',
      },
    ],
    rules: [
